...
void psys_changed_type(struct Object *ob, struct ParticleSystem *psys, struct Scene *scene);

void psys_make_temp_pointcache(struct Object *ob, struct ParticleSystem *psys, struct Scene *scene);
