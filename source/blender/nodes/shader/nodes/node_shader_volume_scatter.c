...
static int node_shader_gpu_volume_scatter(GPUMaterial *mat, bNode *node, bNodeExecData *execdata, GPUNodeStack *in, GPUNodeStack *out)
{
	UNUSED_VARS(node, execdata);
	return GPU_stack_link(mat, "volume_scatter", in, out);
}
